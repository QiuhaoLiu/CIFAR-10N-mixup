...
def main():
    ...
    #到时候在这里加几行代码，把worst和rand1对应的文件报
    # 加载clean训练数据集
    ...
    # 
    # clean_train_set,clean_test_set, _, _ = input_dataset(args.dataset,'clean_label', args.noise_path, args.is_human)
    
    # clean_train_loader= torch.utils.data.DataLoader(dataset = clean_train_set,
    #                                 batch_size = 128,
    #                                 num_workers=8,
    #                                 shuffle=True)
    # clean_test_loader = torch.utils.data.DataLoader(dataset=clean_test_set,
    #                                 batch_size = 64,
    #                                 num_workers=args.num_workers,
    #                                 shuffle=False)   
